...
estimate_bp_disc_optim = function(data, bp = 4) {
...
estimate_bp_segmented = function(data, bp = 3, start_bp = c(39,99,104), 
                                 n_boot = 50,
  ...
  bp_plot = ggplot() +
    ...
    ggsave("D:/Bavaria/before_may (quasi-poisson)/results/disease_onset_bav.png", width = 9, height = 5)
  ...
  bp_plot_infection = ggplot() +
    ...
    theme(
      ...
      legend.title =element_text(size = rel(1.5)),
      legend.position = "bottom") +
    ggsave("D:/Bavaria/before_may (quasi-poisson)/results/disease_onset_bav_shifted.png", width = 9, height = 5)
